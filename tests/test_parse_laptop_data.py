...
from parse_laptop_data import print_laptop_data, list_prices


class TestParseLaptopData(TestCase):
    def setUp(self) -> None:
    ...
    def test_print_laptop_data(self, mock_stdout):
        print_laptop_data('Apple Macbook Pro', 'price')
        print_laptop_data('Dell XPS', 'colors')
        print_laptop_data('Dell XPS', 'screen_size')

        expected = 'Apple Macbook Pro price: [1299, 1499, 1799]\n'
        expected += "Dell XPS colors: ['Platinum silver exterior, black interior', 'Platinum silver exterior, black interior']\n"
        expected += "Dell XPS screen_size: 13-inch\n"

        self.assertEqual(expected, mock_stdout.getvalue())

    
    @mock.patch('sys.stdout', new_callable=io.StringIO)
    def test_list_prices(self, mock_stdout):
        list_prices(self.laptops)
